...
const IPhoneGallery: React.FC<IPhoneGalleryProps> = ({ phones }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-50 to-gray-200 dark:from-neutral-900 dark:to-neutral-800 p-6 md:p-8">
      <motion.div
        ...
        >
          <AnimatePresence>
            {filteredPhones.map((phone) => (
              <motion.div
                key={phone.id}
                className="bg-white dark:bg-neutral-900 rounded-2xl shadow-xl hover:shadow-2xl p-6 transition-all duration-300 transform hover:-translate-y-1 border border-neutral-200 dark:border-neutral-800 cursor-pointer"
                whileHover={{ y: -5 }}
              ...
              >
                ...
                <h3 className="text-xl font-bold text-neutral-800 dark:text-white mb-2 text-center">{phone.name}</h3>
                <p className="text-sm text-neutral-600 dark:text-neutral-300 text-center mb-4">{phone.year}</p>
